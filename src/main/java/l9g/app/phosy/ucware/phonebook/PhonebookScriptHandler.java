...
public class PhonebookScriptHandler
{
  ...
  public final static String CREATE_ATTRIBUTES_FILENAME
    = "jsh" + File.separator + "createPhonebookAttributes.jsh";
  ...
  private final static PhonebookScriptHandler SINGLETON
    = new PhonebookScriptHandler();

  private PhonebookScriptHandler()
  {
    try
    {
  ...
  public static PhonebookScriptHandler getInstance()
  {
    return SINGLETON;
  }
